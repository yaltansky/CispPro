IF OBJECT_ID('V_MFR_R_PROVIDES_ARCHIVE') IS NOT NULL DROP VIEW V_MFR_R_PROVIDES_ARCHIVE
GO
-- SELECT TOP 10 * FROM V_MFR_R_PROVIDES_ARCHIVE WHERE CONTENT_ID > 0
CREATE VIEW V_MFR_R_PROVIDES_ARCHIVE
AS
SELECT 
	CONTENT_ID = ID_MFR,
